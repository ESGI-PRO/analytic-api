...
export const AnalyticsMousePositionTracker = new mongoose.Schema<AnalyticsMousePositionTrackerinterface>({
  appName: {
    type: String,
    required: [true, 'App name can not be empty'],
  },
...
export const AnalyticsMouseClickTracker = new mongoose.Schema<AnalyticsMouseClickTrackerinterface>({
  appName: {
    type: String,
    required: [true, 'App name can not be empty'],
  },
